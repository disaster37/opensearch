...
func TestUnitTasksService_List(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"task_failures":[],"node_failures":[],"nodes":{"n1":{"name":"node1","transport_address":"127.0.0.1:9300","host":"127.0.0.1","ip":"127.0.0.1","roles":["data"],"attributes":{},"tasks":{"n1:100":{"node":"n1","id":100,"type":"transport","action":"indices:data/write/bulk","status":{},"description":"bulk","start_time":"2023-01-01T00:00:00.000Z","start_time_in_millis":1700000000000,"running_time":"100ms","running_time_in_nanos":100000000,"cancellable":true,"cancelled":false,"parent_task_id":"","headers":{}}}}}}`))
	}))
	defer ts.Close()
...
func TestUnitTasksService_Get(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"completed":true,"task":{"node":"n1","id":100,"type":"transport","action":"indices:data/write/bulk","status":{},"description":"bulk","start_time":"2023-01-01T00:00:00.000Z","start_time_in_millis":1700000000000,"running_time":"100ms","running_time_in_nanos":100000000,"cancellable":true,"cancelled":false,"parent_task_id":"","headers":{}}}`))
	}))
	defer ts.Close()
...
func TestUnitTasksService_Cancel(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"task_failures":[],"node_failures":[],"nodes":{"n1":{"name":"node1","transport_address":"127.0.0.1:9300","host":"127.0.0.1","ip":"127.0.0.1","roles":["data"],"attributes":{},"tasks":{}}}}`))
	}))
	defer ts.Close()
