...
func TestUnitCatService_Shards(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"index":"test-idx","shard":"0","prirep":"p","state":"STARTED","docs":"100","store":"1kb","ip":"127.0.0.1","node":"node1","uuid":"abc"}]`))
	}
...
func TestUnitCatService_Aliases(t *testing.T) {
	...
	mux.HandleFunc("/_cat/aliases", func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"alias":"my-alias","index":"test-idx","filter":"-","routing.index":"-","routing.search":"-","is_write_index":"-"}]`))
	})
...
func TestUnitCatService_Health(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"epoch":"1700000000","timestamp":"12:00:00","cluster":"test-cluster","status":"green","node.total":"1","node.data":"1","shards":"5","pri":"5","relo":"0","init":"0","unassign":"0","pending_tasks":"0","max_task_wait_time":"-1ms","active_shards_percent":"100.0%","discovered_cluster_manager":"true"}]`))
	}))
	defer ts.Close()
...
func TestUnitCatService_Count(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"epoch":"1700000000","timestamp":"12:00:00","count":"500"}]`))
	}
...
func TestUnitCatService_Allocation(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"shards":"5","disk.indices":"1gb","disk.used":"10gb","disk.avail":"90gb","disk.total":"100gb","disk.percent":"10","host":"127.0.0.1","ip":"127.0.0.1","node":"node1"}]`))
	}
...
func TestUnitCatService_Fielddata(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"id":"n1","host":"127.0.0.1","ip":"127.0.0.1","node":"node1","field":"my-field","size":"1mb"}]`))
	}
...
func TestUnitCatService_Snapshots(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"id":"snap1","repository":"my-repo","status":"SUCCESS","start_epoch":"1700000000","start_time":"12:00:00","end_epoch":"1700000100","end_time":"12:01:40","duration":"100s","indices":"test-idx","successful_shards":"5","failed_shards":"0","total_shards":"5","reason":""}]`))
	}
...
func TestUnitCatService_Master(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`[{"id":"n1","host":"127.0.0.1","ip":"127.0.0.1","node":"master-node"}]`))
	}))
	defer ts.Close()
...
func TestUnitCatService_NodeAttrs(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/nodeattrs" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"node":"node1","host":"127.0.0.1","ip":"10.0.0.1","attr":"rack","value":"a"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_CatNodes(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/nodes" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"ip":"10.0.0.1","heap.percent":"50","ram.percent":"70","cpu":"10","load_1m":"0.5","load_5m":"0.4","load_15m":"0.3","node.role":"dimr","master":"*","name":"node1","jdk":"17","version":"2.11.0","disk.used_percent":"20"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_CatPendingTasks(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/pending_tasks" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"insertOrder":"1","timeInQueue":"100ms","priority":"HIGH","source":"create-index"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_Plugins(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/plugins" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"name":"analysis-icu","component":"analysis-icu","version":"2.11.0","description":"ICU analyzer plugin"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_CatRecovery(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path == "/_cat/recovery" || r.URL.Path == "/_cat/recovery/test-idx" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"index":"test-idx","shard":"0","start_time":"12:00:00","time":"10s","type":"existing_store","stage":"done","source_host":"127.0.0.1","source_node":"node1","target_host":"127.0.0.1","target_node":"node1","repository":"","snapshot":"","files":"5","files_recovered":"5","files_percent":"100%","bytes":"1000","bytes_recovered":"1000","bytes_percent":"100%","translog_ops":"10","translog_ops_recovered":"10","translog_ops_percent":"100%"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_Repositories(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/repositories" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"id":"my-repo","type":"fs"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_Segments(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path == "/_cat/segments" || r.URL.Path == "/_cat/segments/test-idx" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"index":"test-idx","shard":"0","prirep":"p","ip":"127.0.0.1","id":"abc","segment":"_0","version":"9.7.0","compound":"true","size":"1kb","docs.count":"10","size.memory":"512"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_SegmentReplication(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path == "/_cat/segment_replication" || r.URL.Path == "/_cat/segment_replication/test-idx" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"shard":"test-idx:0","checkpoint":"1","replicating.time_taken":"100ms","get_changes.time_taken":"50ms","total.time_taken":"150ms","accepted.translog_ops":"5"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_CatTasks(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/tasks" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"id":"1","action":"indices:data/read/search","task_id":"abc123","parent_task_id":"-","node_id":"n1","node_ip":"127.0.0.1","running_time":"100ms","type":"transport","description":"search"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_Templates(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path == "/_cat/templates" || r.URL.Path == "/_cat/templates/my-template" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"name":"my-template","index_patterns":"[test-*]","order":"0","version":"1"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_ThreadPool(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.URL.Path == "/_cat/thread_pool" || r.URL.Path == "/_cat/thread_pool/bulk" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"node_name":"node1","name":"bulk","active":"0","pool_size":"5","queue":"0","queue_size":"200","rejected":"0","largest":"5","completed":"1000","type":"fixed"}]`)
			return
		}
		w.WriteHeader(404)
	}))
...
func TestUnitCatService_ClusterManager(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		if r.URL.Path == "/_cat/cluster_manager" && r.URL.Query().Get("format") == "json" {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(200)
			_, _ = fmt.Fprint(w, `[{"ip":"10.0.0.1","id":"n1","host":"127.0.0.1","node":"manager-node"}]`)
			return
		}
		w.WriteHeader(404)
	}))
