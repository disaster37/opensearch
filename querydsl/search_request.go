...
// It encapsulates the indices, types, routing, scroll, and other request-level
// parameters alongside the SearchSource that describes the query body.
// SearchRequest is primarily used in combination with MultiSearch to build
...
func (r *SearchRequest) header() any {
...
func (r *SearchRequest) sourceAsMap() (any, error) {
	if r.source == nil {
