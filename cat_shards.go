...
type CatShardsResponseRow struct {
	...
	MergesWarmerTotalInvocations   int     `json:"merges.warmer.total_invocations,string"`   // warmer total invocations on primaries & replicas
	MergesWarmerTotalTime          string  `json:"merges.warmer.total_time"`                 // warmer total time on primaries & replicas
	MergesWarmerOngoingCount       int     `json:"merges.warmer.ongoing_count,string"`       // warmer ongoing count on primaries & replicas
	MergesWarmerTotalBytesReceived string  `json:"merges.warmer.total_bytes_received"`       // warmer total bytes received on primaries & replicas
	MergesWarmerTotalBytesSent     string  `json:"merges.warmer.total_bytes_sent"`           // warmer total bytes sent on primaries & replicas
	MergesWarmerTotalReceiveTime   string  `json:"merges.warmer.total_receive_time"`         // warmer total receive time on primaries & replicas
	MergesWarmerTotalFailureCount  int     `json:"merges.warmer.total_failure_count,string"` // warmer total failure count on primaries & replicas
	MergesWarmerTotalSendTime      string  `json:"merges.warmer.total_send_time"`            // warmer total send time on primaries & replicas
	...
	SearchQueryFailed              int     `json:"search.query_failed,string"`               // failed query ops on primaries & replicas
	...
	SearchStartreeQueryCurrent     int     `json:"search.startree_query_current,string"` // startree query current on primaries & replicas
	SearchStartreeQueryTime        string  `json:"search.startree_query_time"`           // startree query time on primaries & replicas
	SearchStartreeQueryTotal       int     `json:"search.startree_query_total,string"`   // startree query total on primaries & replicas
	SearchStartreeQueryFailed      int     `json:"search.startree_query_failed,string"`  // startree query failed on primaries & replicas
