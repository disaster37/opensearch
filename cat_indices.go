...
type CatIndicesResponseRow struct {
	...
	MergesWarmerTotalInvocations      int    `json:"merges.warmer.total_invocations,string"`       // total warmer invocations during merges on primaries & replicas
	PriMergesWarmerTotalInvocations   int    `json:"pri.merges.warmer.total_invocations,string"`   // total warmer invocations during merges on primaries
	MergesWarmerTotalTime             string `json:"merges.warmer.total_time"`                     // total time spent in warmer during merges on primaries & replicas
	PriMergesWarmerTotalTime          string `json:"pri.merges.warmer.total_time"`                 // total time spent in warmer during merges on primaries
	MergesWarmerOngoingCount          int    `json:"merges.warmer.ongoing_count,string"`           // ongoing warmer count during merges on primaries & replicas
	PriMergesWarmerOngoingCount       int    `json:"pri.merges.warmer.ongoing_count,string"`       // ongoing warmer count during merges on primaries
	MergesWarmerTotalBytesReceived    string `json:"merges.warmer.total_bytes_received"`           // total bytes received by warmer during merges on primaries & replicas
	PriMergesWarmerTotalBytesReceived string `json:"pri.merges.warmer.total_bytes_received"`       // total bytes received by warmer during merges on primaries
	MergesWarmerTotalBytesSent        string `json:"merges.warmer.total_bytes_sent"`               // total bytes sent by warmer during merges on primaries & replicas
	PriMergesWarmerTotalBytesSent     string `json:"pri.merges.warmer.total_bytes_sent"`           // total bytes sent by warmer during merges on primaries
	MergesWarmerTotalReceiveTime      string `json:"merges.warmer.total_receive_time"`             // total receive time for warmer during merges on primaries & replicas
	PriMergesWarmerTotalReceiveTime   string `json:"pri.merges.warmer.total_receive_time"`         // total receive time for warmer during merges on primaries
	MergesWarmerTotalFailureCount     int    `json:"merges.warmer.total_failure_count,string"`     // total failure count for warmer during merges on primaries & replicas
	PriMergesWarmerTotalFailureCount  int    `json:"pri.merges.warmer.total_failure_count,string"` // total failure count for warmer during merges on primaries
	MergesWarmerTotalSendTime         string `json:"merges.warmer.total_send_time"`                // total send time for warmer during merges on primaries & replicas
	PriMergesWarmerTotalSendTime      string `json:"pri.merges.warmer.total_send_time"`            // total send time for warmer during merges on primaries
	...
	SearchQueryFailed                 int    `json:"search.query_failed,string"`                   // failed query phase ops on primaries & replicas
	PriSearchQueryFailed              int    `json:"pri.search.query_failed,string"`               // failed query phase ops on primaries
	SearchConcurrentQueryCurrent      string `json:"search.concurrent_query_current"`              // current concurrent query ops on primaries & replicas
	PriSearchConcurrentQueryCurrent   string `json:"pri.search.concurrent_query_current"`          // current concurrent query ops on primaries
	SearchConcurrentQueryTime         string `json:"search.concurrent_query_time"`                 // time spent in concurrent query phase on primaries & replicas
	PriSearchConcurrentQueryTime      string `json:"pri.search.concurrent_query_time"`             // time spent in concurrent query phase on primaries
	SearchConcurrentQueryTotal        string `json:"search.concurrent_query_total"`                // total concurrent query phase ops on primaries & replicas
	PriSearchConcurrentQueryTotal     string `json:"pri.search.concurrent_query_total"`            // total concurrent query phase ops on primaries
	SearchConcurrentAvgSliceCount     string `json:"search.concurrent_avg_slice_count"`            // average slice count for concurrent queries on primaries & replicas
	PriSearchConcurrentAvgSliceCount  string `json:"pri.search.concurrent_avg_slice_count"`        // average slice count for concurrent queries on primaries
	SearchStartreeQueryCurrent        int    `json:"search.startree_query_current,string"`         // current startree query ops on primaries & replicas
	PriSearchStartreeQueryCurrent     int    `json:"pri.search.startree.query_current,string"`     // current startree query ops on primaries
	SearchStartreeQueryTime           string `json:"search.startree_query_time"`                   // time spent in startree query phase on primaries & replicas
	PriSearchStartreeQueryTime        string `json:"pri.search.startree.query_time"`               // time spent in startree query phase on primaries
	SearchStartreeQueryFailed         int    `json:"search.startree_query_failed,string"`          // failed startree query ops on primaries & replicas
	PriSearchStartreeQueryFailed      int    `json:"pri.search.startree_query_failed,string"`      // failed startree query ops on primaries
	SearchStartreeQueryTotal          int    `json:"search.startree_query_total,string"`           // total startree query ops on primaries & replicas
	PriSearchStartreeQueryTotal       int    `json:"pri.search.startree.query_total,string"`       // total startree query ops on primaries
	...
	SearchPointInTimeCurrent          string `json:"search.point_in_time_current"`                 // open point in time contexts on primaries & replicas
	PriSearchPointInTimeCurrent       string `json:"pri.search.point_in_time_current"`             // open point in time contexts on primaries
	SearchPointInTimeTime             string `json:"search.point_in_time_time"`                    // time point in time contexts held open on primaries & replicas
	PriSearchPointInTimeTime          string `json:"pri.search.point_in_time_time"`                // time point in time contexts held open on primaries
	SearchPointInTimeTotal            string `json:"search.point_in_time_total"`                   // completed point in time contexts on primaries & replicas
	PriSearchPointInTimeTotal         string `json:"pri.search.point_in_time_total"`               // completed point in time contexts on primaries
	...
	LastIndexRequestTimestamp         int64  `json:"last_index_request_timestamp,string"`          // timestamp of last index request
	LastIndexRequestTimestampString   string `json:"last_index_request_timestamp_string"`          // timestamp of last index request as string
}
